...
export const MOCK_LOANS = [
  {
    id: "loan-1",
    principalIrr: 5000000,
    outstandingIrr: 3500000,
    installmentCount: 12,
    monthlyInstallmentIrr: 291667,
    interestRateMonthlyPercent: 1.5,
    totalRepayableIrr: 3500000,
    status: "active" as const,
    createdAt: new Date(Date.now() - 30 * 24 * 60 * 60 * 1000).toISOString(),
    dueAt: new Date(Date.now() + 11 * 30 * 24 * 60 * 60 * 1000).toISOString(),
  },
]
...
export const MOCK_AUCTIONS = [
  {
    ...
    bidsCount: 12,
    topBidder: { userId: "u-1", displayName: "ALI-71", amount: 85000000 },
  ...
  },
  {
    ...
    bidsCount: 8,
    topBidder: { userId: "u-2", displayName: "MAH-20", amount: 65000000 },
