 ...
 */
export function loadTestDatabase(): PersistentDatabase | null {
  try {
 ...
 */
export function saveTestDatabase(db: PersistentDatabase): void {
  try {
 ...
 */
export function exportStoreToDatabase(
  users: User[],
  transactions: WalletTransaction[],
  spins: WheelSpinRecord[],
  auditLogs: AuditLog[],
